...
-- AddForeignKey
ALTER TABLE "Favorite" ADD CONSTRAINT "Favorite_stockId_fkey" FOREIGN KEY ("stockId") REFERENCES "Stock"("id") ON DELETE CASCADE ON UPDATE CASCADE;
